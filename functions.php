...
function cidw_4w4_enqueue(){
    ...
    wp_enqueue_style('cidw-4w4-police-google', "https://fonts.googleapis.com/css2?family=Playfair+Display&display=swap", false);

    wp_register_script('cidw-4w4-js-modale', 
    get_template_directory_uri() . '/javascript/boite__modale.js', 
    array(), '1.0.0', 
    filemtime(get_template_directory() . '/javascript/boite__modale.js'),
    true );
...
function cidw_4w4_register_nav_menu(){
    register_nav_menus( array(
        ...
        'menu_acueil'  => __( 'Menu accueil', 'cidw_4w4' ),
...
/* ---------------------------------------------------------------------- afficher description choix de menu */
